...
$(document).ready(function() {
    ...
    $(".button-game").on("click", function(event) {
        event.preventDefault();
        if ($('#header-content').hasClass('game-active')) {
            return;
        }
...
$(document).ready(function() {
    ...
    function updateTicketsProgress() {
        ...
        $.get('/tickets/status', function(data) {
            ...
            if (typeof data.availableEarlyBirdTickets !== 'number' || typeof data.totalEarlyBirdTickets !== 'number') {
                return;
            }
            if (typeof data.availableRegularTickets !== 'number' || typeof data.totalRegularTickets !== 'number') {
                return;
            }
